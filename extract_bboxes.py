...
def parse_args():
    ...
    # extractor
    parser.add_argument("--extractor", type=str, default="models/face_detection_yunet_2023mar.onnx")
...
def main(args):
    ...
    video_list = get_videos(args)
    for video in tqdm(video_list, desc=f"Processing {args.dataset_path}"):
        # capture video
